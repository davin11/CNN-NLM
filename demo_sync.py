...
if True:
    ...
    with open("./weights/sar_sync/CNN_NLM_e50.pkl", "rb") as fid:
         args = pickle.load(fid)    
    network_weights = NlmCNN.make_backnet(1, type=args.backnet, sizearea=args.sizearea, bn_momentum=0.1, n3block_opt=args.n3block, padding=False)
    net = NlmCNN.NlmCNN(network_weights, sizearea=args.sizearea, sar_data = True, padding=False)
    net.load_state_dict(torch.load('./weights/sar_sync/CNN_NLM_e50.t7')['net'])
    pad = 18
